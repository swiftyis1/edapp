...
*   [x] **1. Stripe API Setup & Product Catalog**
...
*   [x] **2. Direct B2C Family Checkout (Stripe)**
...
*   [x] **3. School/District B2B Seat License Checkout**
    *   Implement checkout for district administrators to buy blocks of seats (e.g. $5 per seat per year).
    *   Store active subscription details on the `Campus` and `UserProfile` records.
*   [x] **4. Quota Allocation & Check Enforcements**
...
*   [x] **5. Google Classroom / Clever SSO Setup**
...
*   [x] **6. Teacher Invite Code System**
